...
public class Club {
    ...
    public void addMember() {
        if (isFull()) {
            ...
            if (memberExists(id)) {
                JOptionPane.showMessageDialog(null, "El socio con esta cedula ya existe", "Aviso", JOptionPane.WARNING_MESSAGE);
            } else {
    ...
    public void addAuthorizedPersons(String id){
        if(!isFull2()){
            ...
            if(memberExists(idPerson) || personExists(idPerson)){
                JOptionPane.showMessageDialog(null, "El socio o el autorizado con esta cedula ya existe.", "Aviso", JOptionPane.WARNING_MESSAGE);
            }else{
